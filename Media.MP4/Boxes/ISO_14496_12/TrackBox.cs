...
[HasBoxFactory("trgr")]
public class TrackGroupBox : ContainerBox
{
    private TrackGroupBox (BoxHeader header, IsoHandlerBox? handler)
        : base (header, handler)
    {
    }
}
...
public abstract class TrackGroupTypeBox : BoxWithData
{
    ...
    protected TrackGroupTypeBox (BoxHeader header,  IsoHandlerBox? handler)
        : base (header, handler)
    {
    }
