...
[HasBoxFactory("auxl")]
public abstract class AuxiliaryMediaTrackReferenceBox : TrackReferenceTypeBox
{
    private AuxiliaryMediaTrackReferenceBox (BoxHeader header,  IsoHandlerBox? handler)
        : base (header, handler)
    {
    }
}